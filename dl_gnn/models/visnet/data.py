...
from dl_gnn.models.visnet.datasets import *
from dl_gnn.models.visnet.utils import MissingLabelException, make_splits
...
class DataModule(LightningDataModule):
    ...
    def val_dataloader(self):
        ...
        if (
            ...
            and (self.trainer.current_epoch + delta) % self.hparams["test_interval"]
            == 0
        ):
